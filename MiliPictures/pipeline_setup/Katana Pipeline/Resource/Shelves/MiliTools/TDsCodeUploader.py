"""
NAME: TD`s Code Uploader
ICON: icon.png
DROP_TYPES:
SCOPE:

Shelf script that shows basic information and legal notices for Mili Plugins.
"""
...
LOCALROOTPATH = "D:/Projects"
SERVERROOTPATH = "D:/data/Projects"
DEPARTMENT = "PipelineTD"
APPOINTMENT = ""
PROJECT = "DragonNest2"
MODULELIST = ['unknown', 'Model', 'Rig', 'Animation', 'CharacterFX', 'VFX', 'Render', 'PipelineTD', 'RnD', 'PM']
PROJECTLIST = ['DragonNest','DragonNest2', 'PPR','DragonNest2_Test', 'DragonNest2_Test2', 'PPR_VR']
IMAGEPATH = ""
...
class TDsCodeUpload(QtGui.QDialog):
    ...
    def showWindows(self):
        ...
        self.label4_information = QtGui.QLabel(u"Team Member")
    ...
    def setInitValue(self):
        if self.appointment == '':
            self.appointment = u"Team Member"
