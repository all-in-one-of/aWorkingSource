...
class AlembicInBase(object):
    def __init__(self):
        ...
        self.shadingJsonData = self.readJsonDocument(shadingJsonFile)
        self.standardNode = None
        matJsonData = self.readJsonDocument(matJsonFile)
...
class ShadingNetworkBase(object):
    def __init__(self):
        ...
        InJsonFile = "//hnas01/data/Projects/DragonNest2_test/Materials/Characters/NGJL/default/c_NGJL_mat.ShadingJson"
        InKey = "ShadingNodes"
        self.shadingNodeMap = self.readMayaJsonDocument(InJsonFile,InKey)
...
class KatanaSceneBuild():
    def __init__(self):
        self.ShadingNetworkBase = ShadingNetworkBase()
        self.AlembicInBase = AlembicInBase()
