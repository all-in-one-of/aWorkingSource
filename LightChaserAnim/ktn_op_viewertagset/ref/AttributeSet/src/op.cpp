...
public:
    ...
    static void cook(Foundry::Katana::GeolibCookInterface &interface)
    {
        ...
        for (AttributeSetGroups::iterator iter=attributeSetGroups.begin();iter!=attributeSetGroups.end(); ++iter)
        {
            ...
            if(!setAttrs.isValid() &&! deleteAttrNames.isValid() &&! execOps.isValid()) continue;
