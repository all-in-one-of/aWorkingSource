...
for abc in dAbcMap:
    name = abc
    path = dAbcMap[name]
    out_path = "/home/xukai/Documents/TestDataFactory/tea_shop/assets/usd/"+name.split("/")[-1].replace(":","_")+".usd"
    #print name,"---",path
    #print "-",out_path
...
file = open("/home/xukai/Documents/TestDataFactory/tea_shop/assets/map/dUsdMapX.json", "wb")
