...
for abc in dAbcMap:
    name = abc
    path = dAbcMap[name]
    out_path = "/home/xukai/Documents/TestDataFactory/tea_street/assets/abc/"+name.split("/")[-1].replace(":","_")+".abc"
    #print name,"---",path
    #print "-",out_path
...
file = open("/home/xukai/Documents/TestDataFactory/tea_street/assets/map/dUsdMap.json", "wb")
