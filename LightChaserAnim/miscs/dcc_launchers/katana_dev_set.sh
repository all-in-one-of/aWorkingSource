...
export KTOA_HOME=/mnt/proj/software/develop/katana/arnold/KtoA-1.0.7-linux-lca
export ARNOLD_SHADERLIB_PATH=/mnt/proj/software/develop/katana/utility/shaders/lcaShaders
...
export KATANA_RESOURCES=/home/xukai/Documents/develop/devTemp/resources:$KATANA_RESOURCES
...
# multivierse
MFK_HOME=/mnt/proj/software/develop/katana/multiverse/MfK-PublicBeta-v0.1-117-g0feb104-20161128-Linux64
export KATANA_RESOURCES=$MFK_HOME:$KATANA_RESOURCES
export LD_LIBRARY_PATH=$MFK_HOME/lib:$LD_LIBRARY_PATH
