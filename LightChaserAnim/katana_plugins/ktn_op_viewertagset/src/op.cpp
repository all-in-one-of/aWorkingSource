...
class ViewerTagSetOp : public Foundry::Katana::GeolibOp
{
public:
    ...
    static void cook(Foundry::Katana::GeolibCookInterface &interface)
    {
        ...
        FnAttribute::Attribute colorAttr =  interface.getOpArg("color");
        if (!celAttr.isValid())
        {
        ...
        interface.setAttr("viewer.default.annotation.color", colorAttr, false);
        //interface.setAttr("viewer.default.annotation.color.i1", colorGAttr, false);
        //interface.setAttr("viewer.default.annotation.color.i2", colorBAttr, false);
...
DEFINE_GEOLIBOP_PLUGIN(ViewerTagSetOp)

} // anonymous

void registerPlugins()
{
    std::cout << "[LCA PLUGIN] Register ViewerTagSet v1.2" << std::endl;
    REGISTER_PLUGIN(ViewerTagSetOp, "ViewerTagSet", 0, 1);
}
