...
log = logging.getLogger("PyMockAssetWidgetDelegate")
...
class PyMockBrowser(QtGui.QFrame):
    ...
    configureAssetBrowser function of the PyMockAssetWidgetDelegate.
...
class PyMockAssetWidgetDelegate(AssetWidgetDelegatePlugins.BaseAssetWidgetDelegate):
    """
    The widget delegate class that implements BaseAssetWidgetDelegate.
    
    This class is registered to be associated with PyMockAsset and represents
...
# Register the widget delegate to be associated with PyMockAsset 
PluginRegistry = [
    ("AssetWidgetDelegate", 1, "PyMockAsset", PyMockAssetWidgetDelegate),
]
