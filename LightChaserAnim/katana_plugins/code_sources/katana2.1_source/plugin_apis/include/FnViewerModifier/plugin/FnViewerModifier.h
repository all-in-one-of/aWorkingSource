...
namespace Foundry
{
   ...
   */
    ...
    public:
      ...
      /**
       * Returns a bounding box for the current location for use with the viewers scenegraph.
       */
      ...
      static FnViewerModifierPluginSuite_v1 createSuite(FnViewerModifierHandle (*create)(FnAttributeHandle),
                                                        FnAttributeHandle (*getArgumentTemplate)(),
                                                        const char* (*getLocationType)());

      static FnViewerModifierPluginSuite_v1 pluginSuite;
...
#define DEFINE_VMP_PLUGIN(VMP_CLASS)                                                \
    ...
    {                                                                               \
         return Foundry::Katana::ViewerModifier::newViewerModifierHandle(           \
                   VMP_CLASS::create(Foundry::Katana::Attribute::CreateAndRetain(args)) );      \
    }                                                                               \
                                                                                    \
    ...
    {                                                                               \
      return VMP_CLASS::getLocationType();                                          \
                                                                                    ...
                                                                                    \
    FnViewerModifierPluginSuite_v1 VMP_CLASS##_suite =                              \
