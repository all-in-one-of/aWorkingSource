...
class LightQuad(LightManipulator):

    UI_NAME = 'Quad Light'

    vpw = ValuePolicyWrapper

    leftTop          = vpw('material.parameters.Quad_Left_Top')
    leftBottom       = vpw('material.parameters.Quad_Left_Bottom')
    rightTop         = vpw('material.parameters.Quad_Right_Top')
    rightBottom      = vpw('material.parameters.Quad_Right_Bottom')
    topLeft          = vpw('material.parameters.Quad_Top_Left')
    topRight         = vpw('material.parameters.Quad_Top_Right')
    bottomLeft       = vpw('material.parameters.Quad_Bottom_Left')
    bottomRight      = vpw('material.parameters.Quad_Bottom_Right')

    # Read-only:
    coneAngle        = vpw('material.parameters.Cone_Outer_Angle')
