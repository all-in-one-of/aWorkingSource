...
namespace Foundry
{
  namespace Katana
  {
    ...
    FnViewerModifierPluginSuite ViewerModifier::createSuite(
        ...
        void (*onFrameEnd)())
    {
      FnViewerModifierPluginSuite suite = {
        create,
        getArgumentTemplate,
        getLocationType,
        onFrameBegin,
    ...
    unsigned int  ViewerModifier::_apiVersion =
        FnViewerModifierHostSuite_version;
