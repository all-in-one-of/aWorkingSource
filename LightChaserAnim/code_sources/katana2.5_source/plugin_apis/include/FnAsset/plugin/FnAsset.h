...
namespace Foundry
{
  namespace Katana
  {
     ...
     */
    class FNASSET_API SimpleAction
    {
    public:
     ...
     *        transaction.
     */
    class FNASSET_API SimpleTransaction : public AssetTransaction
    {
    public:
...
struct FnAssetTransactionStruct
{
public:
