...
#error "FnGeolibUtil Semaphore not yet implemented in Windows"
    ...
    public:
        ...
        FNKAT_DEPRECATED Semaphore(unsigned int initialCount)
        {
        ...
        FNKAT_DEPRECATED int get_count() const
        {
            int count = 0;
        ...
        FNKAT_DEPRECATED bool try_wait()
        {
#ifdef DEBUG_SEMAPHORE
