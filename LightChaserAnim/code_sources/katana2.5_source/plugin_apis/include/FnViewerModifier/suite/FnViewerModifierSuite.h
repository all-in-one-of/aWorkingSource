...
extern "C"
{
    ...
    struct FnViewerModifierPluginSuite_v2
    {
        FnViewerModifierHandle  (*create)(FnAttributeHandle args);
        FnAttributeHandle       (*getArgumentTemplate)();
        const char*             (*getLocationType)();

        /*! Static callback that is called once per VMP type, before starting
         *  to render a frame.
         */
        void                    (*onFrameBegin)();

        /*! Static callback that is called once per VMP type, when all of the
         *  VMPs' draw callbacks have been called on the visible instances.
         */
        void                    (*onFrameEnd)();
    ...
    #define FnViewerModifierPluginSuite_version 2

    typedef FnViewerModifierPluginSuite_v2 FnViewerModifierPluginSuite;

    #define FnViewerModifierHostSuite_version 2
    ...
    struct FnViewerModifierHostSuite_v1
    {
        ...
        bool              (*isLookedThrough)(FnViewerModifierHostHandle handle, bool includeChildren);
    };
}
