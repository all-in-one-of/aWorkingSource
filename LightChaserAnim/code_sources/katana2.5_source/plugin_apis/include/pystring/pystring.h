...
GEOLIB3_PYSTRING_NAMESPACE_ENTER
{
    ...
    ///
    PYSTRING_API std::string capitalize( const std::string & str );

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Return centered in a string of length width. Padding is done using spaces.
    ///
    PYSTRING_API std::string center( const std::string & str, int width );

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Return the number of occurrences of substring sub in string S[start:end]. Optional
    /// arguments start and end are interpreted as in slice notation.
    ///
    PYSTRING_API int count( const std::string & str, const std::string & substr, int start = 0, int end = MAX_32BIT_INT);
    ...
    ///
    PYSTRING_API bool endswith( const std::string & str, const std::string & suffix, int start = 0, int end = MAX_32BIT_INT );
    ...
    ///
    PYSTRING_API std::string expandtabs( const std::string & str, int tabsize = 8);
    ...
    ///
    PYSTRING_API std::string join( const std::string & str, const std::vector< std::string > & seq );
    ...
    ///
    PYSTRING_API std::string ljust( const std::string & str, int width );

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Return a copy of the string converted to lowercase.
    ///
    PYSTRING_API std::string lower( const std::string & str );
    ...
    ///
    PYSTRING_API std::string lstrip( const std::string & str, const std::string & chars = "" );

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Return a copy of the string, concatenated N times, together.
    /// Corresponds to the __mul__ operator.
    ///
    PYSTRING_API std::string mul( const std::string & str, int n);
    ...
    ///
    PYSTRING_API void partition( const std::string & str, const std::string & sep, std::vector< std::string > & result );
    ...
    ///
    PYSTRING_API std::string replace( const std::string & str, const std::string & oldstr, const std::string & newstr, int count = -1);
    ...
    ///
    PYSTRING_API int rfind( const std::string & str, const std::string & sub, int start = 0, int end = MAX_32BIT_INT );

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Currently a synonym of rfind. The python version raises exceptions. This one currently
    /// does not
    ///
    PYSTRING_API int rindex( const std::string & str, const std::string & sub, int start = 0, int end = MAX_32BIT_INT );

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Return the string right justified in a string of length width. Padding is done using
    /// spaces. The original string is returned if width is less than str.size().
    ///
    PYSTRING_API std::string rjust( const std::string & str, int width);
    ...
    /// not found, the original string will be returned with two empty strings.
    ///
    PYSTRING_API void rpartition( const std::string & str, const std::string & sep, std::vector< std::string > & result );
    ...
    ///
    PYSTRING_API std::string rstrip( const std::string & str, const std::string & chars = "" );
    ...
    /// any whitespace string is a separator.
    ///
    PYSTRING_API void rsplit( const std::string & str, std::vector< std::string > & result, const std::string & sep = "", int maxsplit = -1);
    ...
    ///
    PYSTRING_API void splitlines(  const std::string & str, std::vector< std::string > & result, bool keepends = false );
    ...
    /// position
    ///
    PYSTRING_API bool startswith( const std::string & str, const std::string & prefix, int start = 0, int end = MAX_32BIT_INT );
    ...
    ///
    PYSTRING_API std::string swapcase( const std::string & str );
    ...
    ///
    PYSTRING_API std::string title( const std::string & str );
    ...
    ///
    PYSTRING_API std::string translate( const std::string & str, const std::string & table, const std::string & deletechars = "");

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Return a copy of the string converted to uppercase.
    ///
    PYSTRING_API std::string upper( const std::string & str );
    ...
    ///
    PYSTRING_API std::string zfill( const std::string & str, int width );

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief function matching python's slice functionality.
    ///
    PYSTRING_API std::string slice( const std::string & str, int start = 0, int end = MAX_32BIT_INT);
...
namespace os
{
    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @var sep
    /// @brief The character used by the operating system to separate pathname
    /// components.  This is '/' for POSIX and '\\' for Windows. Note that
    /// knowing this is not sufficient to be able to parse or concatenate
    /// pathnames -- use \c path::split() and \c path::join()
    /// -- but it is occasionally useful.
    ///
    /// @var pathsep
    /// @brief The character conventionally used by the operating system to
    /// separate search path components (as in \c PATH), such as ':' for POSIX
    /// or ';' for Windows.
#if defined(_WIN32)
...
namespace path
{
    ...
    // The path manipulation function below have three versions.
    // Example:
    //   join(...)
    //   join_nt(...)
    //   join_posix(...)
    ...
    // interpreter on the same operating system
    //
    ...
    PYSTRING_API std::string basename(const std::string & path);
    PYSTRING_API std::string basename_nt(const std::string & path);
    PYSTRING_API std::string basename_posix(const std::string & path);

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Return the directory name of pathname path. This is the first half of the pair
    /// returned by split(path).

    PYSTRING_API std::string dirname(const std::string & path);
    PYSTRING_API std::string dirname_nt(const std::string & path);
    PYSTRING_API std::string dirname_posix(const std::string & path);
    ...
    PYSTRING_API bool isabs(const std::string & path);
    PYSTRING_API bool isabs_nt(const std::string & path);
    PYSTRING_API bool isabs_posix(const std::string & s);
    ...
    PYSTRING_API std::string abspath(const std::string & path, const std::string & cwd);
    PYSTRING_API std::string abspath_nt(const std::string & path, const std::string & cwd);
    PYSTRING_API std::string abspath_posix(const std::string & path, const std::string & cwd);
    ...
    PYSTRING_API std::string join(const std::string & path1, const std::string & path2);
    PYSTRING_API std::string join_nt(const std::string & path1, const std::string & path2);
    PYSTRING_API std::string join_posix(const std::string & path1, const std::string & path2);

    PYSTRING_API std::string join(const std::vector< std::string > & paths);
    PYSTRING_API std::string join_nt(const std::vector< std::string > & paths);
    PYSTRING_API std::string join_posix(const std::vector< std::string > & paths);
    ...
    /// On Windows, it converts forward slashes to backward slashes. It should be understood
    /// that this may change the meaning of the path if it contains symbolic links!

    PYSTRING_API std::string normpath(const std::string & path);
    PYSTRING_API std::string normpath_nt(const std::string & path);
    PYSTRING_API std::string normpath_posix(const std::string & path);
    ...
    PYSTRING_API void split(std::string & head, std::string & tail, const std::string & path);
    PYSTRING_API void split_nt(std::string & head, std::string & tail, const std::string & path);
    PYSTRING_API void split_posix(std::string & head, std::string & tail, const std::string & path);
    ...
    PYSTRING_API void splitdrive(std::string & drivespec, std::string & pathspec, const std::string & path);
    PYSTRING_API void splitdrive_nt(std::string & drivespec, std::string & pathspec, const std::string & p);
    PYSTRING_API void splitdrive_posix(std::string & drivespec, std::string & pathspec, const std::string & path);
    ...
    PYSTRING_API void splitext(std::string & root, std::string & ext, const std::string & path);
    PYSTRING_API void splitext_nt(std::string & root, std::string & ext, const std::string & path);
    PYSTRING_API void splitext_posix(std::string & root, std::string & ext, const std::string & path);

    //////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief Expand paths beginning with '~' or '~user'.
    /// '~' means the current user's home directory; '~user' means that user's
    /// home directory. If the path doesn't begin with '~', or if the user or
    /// their home directory is unknown, the path is returned unchanged
    /// (leaving error reporting to whatever function is called with the
    /// expanded path as argument).
    PYSTRING_API std::string expanduser(const std::string & path);

    //////////////////////////////////////////////////////////////////////////////////////////////
    class EnvironmentInterface;

    /// @brief Return the argument with environment variables expanded.
    /// Substrings of the form '$name' or '${name}' are replaced by the value
    /// of environment variable name. Malformed variable names and references
    /// to non-existent variables are left unchanged. By default, environment
    /// variables are provided by \c ::getenv(), but a custom \c environment
    /// may also be specified.
    PYSTRING_API std::string expandvars(
        const std::string& path,
        EnvironmentInterface* environment = NULL);

    class PYSTRING_API EnvironmentInterface
    {
    public:
        virtual ~EnvironmentInterface()
        {
        }
        virtual bool getenv(const std::string& key,
