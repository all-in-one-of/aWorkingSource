...
bool ApplyCameraAttributeChanges( const std::string  &nodeName, FnAttribute::GroupAttribute params )
{
    ...
    // TODO: allow these params to be updated once we get them from the right groups
    std::vector<std::string> cameraparams;
//    cameraparams.push_back("shutter_start");
//    cameraparams.push_back("shutter_end");
//    cameraparams.push_back("shutter_type");
    cameraparams.push_back("filtermap");
//    cameraparams.push_back("focus_distance");
//    cameraparams.push_back("plane_distance");
//    cameraparams.push_back("aperture_size");
