...
FNGEOLIBOP_NAMESPACE_ENTER
{
    ...
    public:
        ...
        /** @name Query Input
          ...
          *
          * It is recommended that, if your Op makes multiple scattered queries
          * in a single cook call
          * prefetch(const std::string &, int) const should be used.
          *
          * @{
          */
